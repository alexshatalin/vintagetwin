<section data-id="slider" class="slider hero">
		...
		<div class="slider_mask">
			...
			<div class="single_slide">
				...
				<div class="slide_content">
					<div class="text">Reworked<br /> Hunted<br /> Treasure</div>
					<a href="#">shop now <div class="pointer"></div></a>
				</div>
			</div>
			...
			<div class="single_slide">
				...
				<div class="slide_content">
					<div class="text">Aliquam venenatis diam eget tortor aliquam</div>
					<a href="#">shop now<div class="pointer"></div></a>
				</div>
			</div>
			...
			<div class="single_slide">
				...
				<div class="slide_content">
					<div class="text">Fusce pulvinar interdum nisl</div>
					<a href="#">shop now <div class="pointer"></div></a>
				</div>
			</div>
			...
			<div class="single_slide">
				...
				<div class="slide_content">
					<div class="text">Nunc posuere nec nunc id ullamcorper</div>
					<a href="#">shop now<div class="pointer"></div></a>
				</div>
			</div>
